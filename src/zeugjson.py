...
def read_file(path: str) -> list:
    with open(path, mode='r') as file_handler:
        return [line.strip('\n') for line in file_handler.readlines()] # list comprehension'

def print_slow(msg: str, end='') -> None: #end='\n' vertikal
    for char in msg:
        print(char, end=end, flush=True)
        time.sleep(0.05)

def color_string(msg: str, r: int, g: int, b: int) -> str:     #rgb alpha
...
def credits(lp: int, guess_meword: str, mode: str) -> None:
    lost = ("You lost!")
    won = ("You won!")
    #print("You {}! You word was \n{}".format('won' if lp > 0 else 'lost', guess_meword))
    red = (138, 3, 3)
    green = (24, 143, 0)
    if lp > 0:
...
if __name__ == '__main__':
    ...
    # print_slow("Goodby World!")

    red = (138, 3, 3)
    # green = (24, 143, 0)
    # msg = "Helooooooooooo"
    # msg = "You {}! You word was \n{}".format('won' if lp > 0 else 'lost', guess_meword)

    # print(color_string(msg, red[0], red[1], red[2]))
